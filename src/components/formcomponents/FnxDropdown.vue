<template>
  <div class="fnx-field" :class="fieldClass">
    ...
    <!-- Dropdown wrapper -->
    <div class="fnx-dropdown-wrapper">
      <!-- Dropdown element -->
      <Select
        :id="dropdownId"
        ref="dropdownRef"
      ...
      <!-- Loading spinner -->
      <div v-if="loading" class="fnx-dropdown-loading">
...
const dropdownId = computed(() => `fnx-dropdown-${props.name}`)
...
const dropdownClasses = computed(() => [
  'fnx-dropdown',
  `fnx-dropdown--${props.size}`,
  {
    'fnx-dropdown--error': !!errorMessage.value,
    'fnx-dropdown--success': meta.valid && meta.touched && !errorMessage.value,
    'fnx-dropdown--loading': props.loading
  }
])
