<template>
  ...
  >
    ...
    <div
      v-if="loading"
      class="fnx-icon-button-loading-spinner"
      :aria-hidden="true"
    />
    
    <!-- Icon content (hidden when loading) -->
    <div v-if="!loading" class="fnx-icon-button-content">
      <div class="fnx-icon-button-icon" :aria-hidden="true">
    ...
    <div
      ...
      class="fnx-icon-button-tooltip"
      :class="`fnx-icon-button-tooltip--${tooltipPosition}`"
    >
      {{ tooltip }}
    </div>
  </button>
...
const buttonClasses = computed(() => [
  'fnx-icon-button',
  `fnx-icon-button--${props.size}`,
  `fnx-icon-button--${props.severity}`,
  `fnx-icon-button--${props.variant}`,
  {
    'fnx-icon-button--rounded': props.rounded,
    'fnx-icon-button--square': !props.rounded,
    'fnx-icon-button--loading': props.loading,
    'fnx-icon-button--disabled': props.disabled
  },
  props.class
])
...
@use './styles/fnx-icon-button.scss';
</style>
