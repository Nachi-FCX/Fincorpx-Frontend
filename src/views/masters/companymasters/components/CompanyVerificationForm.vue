<template>
  <div class="company-verification-form">
    <!-- Form Header -->
    ...
    <div class="verification-content">
      ...
      <div class="company-details">
        <div class="detail-row">
          ...
          <span class="detail-value">{{ companyData.lgnm }}</span>
        </div>
        
        <div class="detail-row">
          <span class="detail-label">GSTIN:</span>
          <span class="detail-value">{{ companyData.gstin }}</span>
        </div>
        ...
        <div v-if="companyData.tradeNam && companyData.tradeNam !== companyData.lgnm" class="detail-row">
          <span class="detail-label">Trade Name:</span>
          <span class="detail-value">{{ companyData.tradeNam }}</span>
        </div>
        ...
        <div v-if="companyData.pradr?.addr" class="detail-row">
...
const extractedStateCode = computed(() => {
  return extractStateCodeFromGSTIN(props.companyData.gstin)
})

const formattedAddress = computed(() => {
  return formatCompanyAddress(props.companyData)
})
